...
public Student updateStudent(int studentId, Student student) {
    ...
    db.update("upadate student set studentName = ? where studentId = ?", student.getStudentName(), studentId);
    }
    if (student.getGender() != null) {
    db.update("upadate student set Gender = ? where studentId = ?", student.getGender(), studentId);
    }
    (student.getStudentName() != 0) {
    db.update("upadate student set studentName = ? where studentId = ?", student.getStudentName(), studentId);
    }
